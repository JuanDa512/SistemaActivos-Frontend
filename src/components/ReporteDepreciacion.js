...
/*
function ReporteDepreciacion(activo) {
    const styles = ({
      table: { 
        display: "table",
        borderStyle: "solid", 
      ...
      <Document>
        ...
        >
          ...
          >
            ...
            <Text>Identificacion de Monitoreo N° {activo.id_monitoreo}</Text>
            <Text>Area de lectura: {activo.name_area}  Bloque {activo.bloque}  {activo.piso}</Text>
          </View>
