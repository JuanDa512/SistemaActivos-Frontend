...
export const getDepreciacionRequest = async (newData) => 
    await axios.post('http://localhost:4000/depreciacion/', newData);
...
export const getTipoRequest = async (id) => 
    await axios.get(`http://localhost:4000/tipo/${id}`);
